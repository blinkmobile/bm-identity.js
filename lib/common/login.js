 ...
 * @param {String} [options.tenant] - The tenant used to authenticate i.e. ONEBLINK | CIVICPLUS.
...
async function login(options /* : ?LoginOptions */) /* : Promise<string> */ {
  options = options || {}
  if (options.username) {
    const loginProvider = new UsernameLoginProvider(options.tenant)
    ...
    const loginProvider = new BrowserLoginProvider(options.tenant)
